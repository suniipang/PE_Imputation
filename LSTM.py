...
for train, test in logo.split(Ximp_scaled, Yimp, groups=wells_noPE):
    ...
    # print(Ximp_scaled[test].shape,Yimp[test].shape) #(404,7) (404,)
    # print(Ximp_scaled[train].shape, Yimp[train].shape) #(2760, 7) (2760,)
    ...
    history = model.fit(trainX, trainY, epochs=100, batch_size=8, validation_data=(testX, testY), verbose=2, shuffle=False, callbacks=[early_stopping])
